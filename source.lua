...
localizations.values = {
    ...
    buildable_storageArea = "Storage Area",
    buildable_storageArea_plural = "Storage Areas",
    ...
    buildable_campfire_summary = "The campfire provides warmth and light, and allows cooking of food to increase its nutritional value.",
    ...
    buildable_mudBrickWall_summary = "A sturdy wall. Dimensions: 4x2",
    buildable_mudBrickWallDoor = "Mudbrick Wall With Door",
    buildable_mudBrickWallDoor_plural = "Mudbrick Walls With Doors",
    buildable_mudBrickWallDoor_summary = "A sturdy wall. Dimensions: 4x2",
...
Promotional Illustrations by Jeremy Forveille
